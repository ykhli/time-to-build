...
- `heads/*.svg` — 50 flower-head species generated with [QuiverAI](https://quiver.ai) (arrow-1.1), embedded inline. As notes play, flowers bloom in around the photo — a dense band along the street, climbing the torn edges, a sparse crown on top — until the building sits in a sea of flowers. Sustained music re-blooms them bigger; when the music stops they freeze and keep their bloom.
